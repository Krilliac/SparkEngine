 ...
 * @brief D3D11 graphics state management, metrics, settings, and resize
 *
 * Contains ApplyGraphicsState, UpdateMetrics, quality presets, render path settings,
 * MSAA/TAA/SSAO/SSR settings, OnResize, and statistics methods.
