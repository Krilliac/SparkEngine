     ...
     */
        void Update(float dt)
        {
            ...
            if (m_fogSystem)
            {
                ...
                m_fogSystem->SetColor({m_currentState.fogColor.x, m_currentState.fogColor.y, m_currentState.fogColor.z,
                                       m_currentState.fogColor.w});
        ...
        float GetEffectiveWindSpeed() const { return m_currentState.windSpeed + m_currentWindGust; }
        ...
        void SetOnWeatherChanged(WeatherCallback callback) { m_onWeatherChanged = std::move(callback); }
