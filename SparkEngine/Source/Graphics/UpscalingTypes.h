/**
 * @file UpscalingTypes.h
 * @brief Type definitions for the upscaling system: enums, structs, constants
 * @author Spark Engine Team
 * @date 2026
 *
 * Contains all standalone types used by UpscalingSystem: Resolution, UpscalingMode,
 * UpscalingQuality, UpscalingInputRequirements, UpscalingSettings, GPU constant
 * buffer structs (FSR 1.0/2.0, DLSS/XeSS), dispatch descriptions, and feature info.
 */
