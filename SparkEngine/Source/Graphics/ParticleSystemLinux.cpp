/**
 * @file ParticleSystemLinux.cpp
 * @brief Linux ParticleSystem manager and console helpers — split from ParticleSystem.cpp.
 *        The ParticleEmitter implementation lives in ParticleSystemLinuxEmitter.cpp.
 */
