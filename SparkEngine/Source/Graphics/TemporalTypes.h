 ...
 * @brief Settings, enums, jitter generation, and helper types for temporal effects
 * @author Spark Engine Team
 * @date 2025
 *
 * Contains TAA/motion blur settings, jitter pattern enums, the JitterGenerator
 * namespace, MotionVectorData, FrameHistory, and NeighborhoodClamp utilities.
 *
 * @see TemporalEffects.h
 */
