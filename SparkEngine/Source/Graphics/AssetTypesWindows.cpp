 ...
 * @brief Windows/D3D11 asset type implementations (MeshAsset, TextureAsset, AudioAsset, AssetCache)
 *
 * Contains the D3D11 GPU buffer creation, WIC texture loading, and Windows-specific
 * asset cache logic. The Linux counterpart lives in AssetTypesLinux.cpp.
