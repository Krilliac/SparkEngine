 ...
 */
     ...
     */
        std::wstring Console_GetStatus() const
        {
            ...
            float usagePercent =
                m_capacity > 0 ? (static_cast<float>(m_metrics.usedThisFrame) / static_cast<float>(m_capacity)) * 100.0f
                               : 0.0f;
            float peakPercent =
                m_capacity > 0
            ...
            swprintf(buf, 256,
                     ...
                     m_capacity / 1024, m_metrics.usedThisFrame / 1024, usagePercent, m_metrics.allocationsThisFrame,
                     m_metrics.peakUsageBytes / 1024, peakPercent);
