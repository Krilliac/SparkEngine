 ...
 * @date 2026
 *
 * Contains methods that require D3D11/Windows headers:
 ...
 *
 * Per-backend Execute methods (FSR1, FSR2, DLSS, XeSS, SparkSR) live in
 * UpscalingSystemWindowsExecute.cpp; shared UpscalingUtils declarations in
 * UpscalingSystemWindowsInternal.h. The companion UpscalingSystem.cpp houses
 * cross-platform utilities (Halton jitter, DLL detection, resolution
 * calculation, mode/quality names).
 */
