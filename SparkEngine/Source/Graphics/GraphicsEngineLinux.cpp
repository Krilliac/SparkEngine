 ...
 * @brief Linux RHI-bridge lifecycle (Initialize/Shutdown/Resize) for SparkEngine
 *
 * Routes rendering through the RHI bridge (GraphicsEngineRHI.h).
 * Per-frame path lives in GraphicsEngineLinuxFrame.cpp, accessors in
 * GraphicsEngineLinuxAccessors.cpp, render-target helpers in
 * GraphicsEngineLinuxRenderTargets.cpp. Windows counterpart lives in
 * GraphicsEngineWindows.cpp.
 */
...
// The platform RT helpers (CreatePlatformRenderTargets /
// ReleasePlatformRenderTargets) are declared in GraphicsEngineRHI.h and
// defined in GraphicsEngineLinuxRenderTargets.cpp.
