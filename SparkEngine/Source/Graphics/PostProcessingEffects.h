/**
 * @file PostProcessingEffects.h
 * @brief Post-processing effect type definitions and settings structs
 * @author Spark Engine Team
 * @date 2025
 *
 * Contains the enums and settings structs for all post-processing effects
 * (FXAA, DOF, Vignette, Chromatic Aberration, Film Grain, etc.) and
 * per-pass performance metrics.
 *
 * @see PostProcessingPipeline.h
 */
