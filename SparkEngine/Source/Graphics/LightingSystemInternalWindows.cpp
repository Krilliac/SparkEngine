 ...
 * light buffer updates, light culling, IBL generation (irradiance, prefilter, BRDF LUT),
 * and default environment creation. Split from LightingSystem.cpp for maintainability.
 */
