/**
 * @file Mesh.h
 * @brief 3D mesh management and primitive generation system (umbrella header)
 ...
 *
 * This is the umbrella header for the mesh system. It includes:
 * - MeshTypes.h — Vertex, MeshData, and MeshSubmesh structures
 * - Mesh class  — Buffer management, primitives, and rendering (defined below)
 */
