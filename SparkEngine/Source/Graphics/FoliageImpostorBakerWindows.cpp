 ...
 * methods: atlas texture creation, shader compilation, cell buffer upload,
 * per-slot rasterization baking, and the full BakeAllRegisteredSpecies
 * orchestrator.
 *
 * The CPU-portable helpers (atlas layout, angle slot math, UV computation)
 * remain in FoliageImpostorBaker.cpp and run on all platforms.
 */
