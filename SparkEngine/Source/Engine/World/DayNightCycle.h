 ...
 */
     ...
     */
        ...
        DayPeriod GetDayPeriod() const
        {
            ...
            if (m_currentHour < 7.0f)
                return DayPeriod::Dawn;
            if (m_currentHour < 10.0f)
                return DayPeriod::Morning;
            if (m_currentHour < 14.0f)
                return DayPeriod::Midday;
            if (m_currentHour < 17.0f)
                return DayPeriod::Afternoon;
            if (m_currentHour < 19.0f)
                return DayPeriod::Dusk;
            if (m_currentHour < 21.0f)
      ...
      private:
        void UpdateSunPosition()
        {
            ...
            // Normalize
            float len = std::sqrt(m_sunDirection.x * m_sunDirection.x + m_sunDirection.y * m_sunDirection.y +
