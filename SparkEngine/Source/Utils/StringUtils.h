...
namespace Spark { namespace StringUtils {
...
inline std::string ToString(unsigned int value) { return std::to_string(value); }
inline std::string ToString(unsigned long value) { return std::to_string(value); }
inline std::string ToString(unsigned long long value) { return std::to_string(value); }
...
inline std::string Format(const char* fmt, ...) {
    ...
    va_end(args);
    if (size < 0) { va_end(args_copy); return ""; }
