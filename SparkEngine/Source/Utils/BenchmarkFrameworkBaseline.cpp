/**
 * @file BenchmarkFrameworkBaseline.cpp
 * @brief Baseline persistence and regression comparison for BenchmarkFramework
 *
 * Split from BenchmarkFramework.cpp: SaveBaseline/LoadBaseline JSON I/O,
 * CompareWithBaseline/HasRegressions, and the static JSON/file helpers.
 */
