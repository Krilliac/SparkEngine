...
public:
    ...
    void DrawRay(const DirectX::XMFLOAT3& origin,
                 const DirectX::XMFLOAT3& direction,
                 float length,
                 const DebugColor& color = DebugColor::Green(),
                 float lifetime = 0.0f,
                 bool depthTested = true)
    {
        DebugDrawRequest req;
    ...
    void DrawArrow(const DirectX::XMFLOAT3& start,
                   const DirectX::XMFLOAT3& end,
                   float headSize,
                   const DebugColor& color = DebugColor::Yellow(),
                   float lifetime = 0.0f,
                   bool depthTested = true)
    {
        DebugDrawRequest req;
    ...
    void DrawSphere(const DirectX::XMFLOAT3& center,
                    float radius,
                    const DebugColor& color = DebugColor::Cyan(),
                    float lifetime = 0.0f,
                    int segments = 16,
                    bool depthTested = true)
    {
    ...
    void DrawCapsule(const DirectX::XMFLOAT3& base,
                     float radius,
                     float height,
                     const DebugColor& color = DebugColor::Magenta(),
                     float lifetime = 0.0f,
                     bool depthTested = true)
    {
        DebugDrawRequest req;
    ...
    void DrawCross(const DirectX::XMFLOAT3& position,
                   float size,
                   const DebugColor& color = DebugColor::Red(),
                   float lifetime = 0.0f,
                   bool depthTested = true)
    {
        DebugDrawRequest req;
    ...
    void DrawCone(const DirectX::XMFLOAT3& apex,
                  const DirectX::XMFLOAT3& direction,
                  float height,
                  float angle,
                  const DebugColor& color = DebugColor::Orange(),
                  float lifetime = 0.0f,
                  bool depthTested = true)
    {
        DebugDrawRequest req;
    ...
    void DrawText3D(const DirectX::XMFLOAT3& position,
    ...
    void DrawGrid(const DirectX::XMFLOAT3& center,
                  float cellSize,
                  int cellCount,
                  const DebugColor& color = {0.3f, 0.3f, 0.3f, 0.5f},
                  float lifetime = 0.0f)
    {
        DebugDrawRequest req;
    ...
    void DrawAxes(const DirectX::XMFLOAT3& position,
                  float length = 1.0f,
                  float lifetime = 0.0f,
                  bool depthTested = true)
    {
        DrawArrow(position, {position.x + length, position.y, position.z},
                  length * 0.1f, DebugColor::Red(), lifetime, depthTested);
        DrawArrow(position, {position.x, position.y + length, position.z},
                  length * 0.1f, DebugColor::Green(), lifetime, depthTested);
        DrawArrow(position, {position.x, position.y, position.z + length},
                  length * 0.1f, DebugColor::Blue(), lifetime, depthTested);
    }
     ...
     */
    const std::vector<DebugDrawRequest>& GetRequests() const
    {
        return m_requests;
    }
...
#  define DEBUG_DRAW_LINE(start, end, color) \
       Spark::DebugDrawManager::GetInstance().DrawLine(start, end, color)
#  define DEBUG_DRAW_LINE_T(start, end, color, time) \
       Spark::DebugDrawManager::GetInstance().DrawLine(start, end, color, time)
#  define DEBUG_DRAW_RAY(origin, dir, len, color) \
       Spark::DebugDrawManager::GetInstance().DrawRay(origin, dir, len, color)
...
#  define DEBUG_DRAW_AABB(mn, mx, color) \
       Spark::DebugDrawManager::GetInstance().DrawAABB(mn, mx, color)
#  define DEBUG_DRAW_AABB_T(mn, mx, color, time) \
       Spark::DebugDrawManager::GetInstance().DrawAABB(mn, mx, color, time)
...
#  define DEBUG_DRAW_CROSS(pos, size, color) \
       Spark::DebugDrawManager::GetInstance().DrawCross(pos, size, color)
...
#  define DEBUG_DRAW_TEXT3D(pos, text, color) \
       Spark::DebugDrawManager::GetInstance().DrawText3D(pos, text, color)
...
#  define DEBUG_DRAW_AXES(pos, length) \
       Spark::DebugDrawManager::GetInstance().DrawAxes(pos, length)
#else
