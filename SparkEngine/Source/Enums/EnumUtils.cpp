...
namespace SparkEditor
{
    ...
    template <> std::string EnumUtils<WeaponType>::ToString(WeaponType value)
    {
    ...
    template <> WeaponType EnumUtils<WeaponType>::FromString(const std::string& str)
    {
    ...
    template <> std::vector<WeaponType> EnumUtils<WeaponType>::GetAllValues()
    {
        return {WeaponType::PISTOL,           WeaponType::RIFLE,
                WeaponType::SHOTGUN,          WeaponType::ROCKET_LAUNCHER,
                WeaponType::GRENADE_LAUNCHER, WeaponType::SNIPER_RIFLE,
                WeaponType::SUBMACHINE_GUN,   WeaponType::ASSAULT_RIFLE,
                WeaponType::MACHINE_GUN,      WeaponType::FLAMETHROWER,
                WeaponType::PLASMA_RIFLE,     WeaponType::LASER_CANNON,
                WeaponType::RAILGUN,          WeaponType::MINIGUN,
                WeaponType::CROSSBOW,         WeaponType::BOW,
                WeaponType::THROWING_KNIFE,   WeaponType::MELEE_WEAPON,
                WeaponType::GRAPPLING_HOOK,   WeaponType::SCANNER,
                WeaponType::REPAIR_TOOL,      WeaponType::MEDICAL_TOOL,
                WeaponType::CUSTOM_1,         WeaponType::CUSTOM_2,
                WeaponType::CUSTOM_3};
    }

    // MovementState specialization
    template <> std::string EnumUtils<MovementState>::ToString(MovementState value)
    {
    ...
    template <> MovementState EnumUtils<MovementState>::FromString(const std::string& str)
    {
    ...
    template <> std::vector<MovementState> EnumUtils<MovementState>::GetAllValues()
    {
        return {
            MovementState::IDLE,      MovementState::WALKING,  MovementState::RUNNING,      MovementState::SPRINTING,
            MovementState::CROUCHING, MovementState::CRAWLING, MovementState::JUMPING,      MovementState::FALLING,
            MovementState::CLIMBING,  MovementState::SWIMMING, MovementState::SLIDING,      MovementState::WALL_RUNNING,
            MovementState::GRAPPLING, MovementState::STUNNED,  MovementState::KNOCKED_DOWN, MovementState::DEAD};
    }

    // HealthState specialization
    template <> std::string EnumUtils<HealthState>::ToString(HealthState value)
    {
    ...
    template <> HealthState EnumUtils<HealthState>::FromString(const std::string& str)
    {
    ...
    template <> std::vector<HealthState> EnumUtils<HealthState>::GetAllValues()
    {
        return {HealthState::HEALTHY,  HealthState::INJURED,      HealthState::CRITICAL,    HealthState::BLEEDING,
                HealthState::POISONED, HealthState::BURNING,      HealthState::FROZEN,      HealthState::ELECTRIFIED,
                HealthState::DEAD,     HealthState::INVULNERABLE, HealthState::REGENERATING};
    }

    // DamageType specialization
    template <> std::string EnumUtils<DamageType>::ToString(DamageType value)
    {
        static const std::unordered_map<DamageType, std::string> typeNames = {{DamageType::PHYSICAL, "Physical"},
    ...
    template <> DamageType EnumUtils<DamageType>::FromString(const std::string& str)
    {
        static const std::unordered_map<std::string, DamageType> nameToType = {{"physical", DamageType::PHYSICAL},
    ...
    template <> std::vector<DamageType> EnumUtils<DamageType>::GetAllValues()
    {
        return {DamageType::PHYSICAL, DamageType::FIRE,      DamageType::ICE,         DamageType::ELECTRIC,
                DamageType::POISON,   DamageType::EXPLOSIVE, DamageType::ENERGY,      DamageType::PSYCHIC,
                DamageType::HOLY,     DamageType::DARK,      DamageType::SONIC,       DamageType::RADIATION,
                DamageType::PIERCING, DamageType::SLASHING,  DamageType::BLUDGEONING, DamageType::TRUE_DAMAGE};
    }
...
namespace SparkEditor
{
    ...
    // --- GraphicsAPI ---
    template <> std::string EnumUtils<SparkEngine::GraphicsAPI>::ToString(SparkEngine::GraphicsAPI value)
    {
        using SparkEngine::GraphicsAPI;
        static const std::unordered_map<GraphicsAPI, std::string> names = {{GraphicsAPI::DIRECTX_11, "DirectX 11"},
    ...
    template <> SparkEngine::GraphicsAPI EnumUtils<SparkEngine::GraphicsAPI>::FromString(const std::string& str)
    {
        using SparkEngine::GraphicsAPI;
        static const std::unordered_map<std::string, GraphicsAPI> nameToType = {{"directx 11", GraphicsAPI::DIRECTX_11},
    ...
    template <> std::vector<SparkEngine::GraphicsAPI> EnumUtils<SparkEngine::GraphicsAPI>::GetAllValues()
    {
        using SparkEngine::GraphicsAPI;
        return {GraphicsAPI::DIRECTX_11, GraphicsAPI::DIRECTX_12, GraphicsAPI::OPENGL, GraphicsAPI::VULKAN,
                GraphicsAPI::METAL};
    }

    // --- InputAction ---
    template <> std::string EnumUtils<SparkEngine::InputAction>::ToString(SparkEngine::InputAction value)
    {
        using SparkEngine::InputAction;
        static const std::unordered_map<InputAction, std::string> names = {{InputAction::PRESSED, "Pressed"},
    ...
    template <> SparkEngine::InputAction EnumUtils<SparkEngine::InputAction>::FromString(const std::string& str)
    {
        using SparkEngine::InputAction;
        static const std::unordered_map<std::string, InputAction> nameToType = {{"pressed", InputAction::PRESSED},
    ...
    template <> std::vector<SparkEngine::InputAction> EnumUtils<SparkEngine::InputAction>::GetAllValues()
    {
        using SparkEngine::InputAction;
        return {InputAction::PRESSED, InputAction::RELEASED, InputAction::HELD, InputAction::REPEATED};
    }
