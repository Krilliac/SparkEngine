...
function(spark_define_component_libraries)
    ...
    target_compile_features(SparkCore PUBLIC cxx_std_23)
    ...
    target_compile_features(SparkUtils PUBLIC cxx_std_23)
    ...
    target_compile_features(SparkECS PUBLIC cxx_std_23)
    ...
    target_compile_features(SparkGraphics PUBLIC cxx_std_23)
    ...
    target_compile_features(SparkPhysics PUBLIC cxx_std_23)
    ...
    if(SPARK_AUDIO_SOURCES)
        ...
        target_compile_features(SparkAudio PUBLIC cxx_std_23)
    ...
    if(SPARK_AI_SOURCES)
        ...
        target_compile_features(SparkAI PUBLIC cxx_std_23)
    ...
    if(SPARK_ANIMATION_SOURCES)
        ...
        target_compile_features(SparkAnimation PUBLIC cxx_std_23)
    ...
    if(SPARK_NET_SOURCES)
        ...
        target_compile_features(SparkNetworking PUBLIC cxx_std_23)
