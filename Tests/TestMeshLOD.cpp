...
float ComputeEdgeCost(float px0, float py0, float pz0,
...
TEST(LODSelection_MidDistance)
{
    TestLOD::LODChain chain;
    chain.levels = {
        {0.0f, 1.0f, 1000, 100.0f},
        {20.0f, 0.5f, 500, 50.0f},
        {40.0f, 0.25f, 250, 25.0f},
        {80.0f, 0.1f, 100, 10.0f}
    };
...
{
    float cost = TestLOD::ComputeEdgeCost(
