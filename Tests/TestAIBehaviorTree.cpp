...
{
    TestAI::Blackboard bb;
    TestAI::ActionNode node([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Success; });
...
{
    TestAI::Blackboard bb;
    TestAI::ActionNode node([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Failure; });
...
TEST(ConditionNode_TrueCondition)
{
    ...
    TestAI::ConditionNode node([](const TestAI::Blackboard& b) { return b.Get<bool>("hasTarget", false); });
    EXPECT_TRUE(node.Tick(0.016f, bb) == TestAI::NodeStatus::Success);
}
...
TEST(SequenceNode_AllSucceed)
{
    ...
    seq.AddChild(
        std::make_unique<TestAI::ActionNode>([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Success; }));
    seq.AddChild(
        std::make_unique<TestAI::ActionNode>([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Success; }));
...
TEST(SequenceNode_OneFails)
{
    ...
    seq.AddChild(
        std::make_unique<TestAI::ActionNode>([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Success; }));
    seq.AddChild(
        std::make_unique<TestAI::ActionNode>([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Failure; }));
    seq.AddChild(
        std::make_unique<TestAI::ActionNode>([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Success; }));
...
TEST(InverterNode_KeepsRunning)
{
    TestAI::Blackboard bb;
    auto inverter = std::make_unique<TestAI::InverterNode>(
        std::make_unique<TestAI::ActionNode>([](float, TestAI::Blackboard&) { return TestAI::NodeStatus::Running; }));
