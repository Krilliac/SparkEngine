...
namespace TestTemporal
{
    ...
    {
        return {0.25f * rgb.r + 0.5f * rgb.g + 0.25f * rgb.b, 0.5f * rgb.r - 0.5f * rgb.b,
    ...
    {
        return {ClampValue(color.r, box.minC.r, box.maxC.r), ClampValue(color.g, box.minC.g, box.maxC.g),
...
{
    std::vector<TestTemporal::Color3> samples = {{0.1f, 0.2f, 0.3f}, {0.5f, 0.6f, 0.1f}, {0.3f, 0.4f, 0.8f}};
