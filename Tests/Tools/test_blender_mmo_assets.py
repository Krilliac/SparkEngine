...
from blender.validate_mmo_props import NAMES, validate_exports, validate_model, validate_provenance


class SourceContractTests(unittest.TestCase):
    def test_tracked_asset_bundle_has_valid_provenance(self):
