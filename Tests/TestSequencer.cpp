...
{
    std::vector<TestSequencer::CameraKeyframe> kfs = {{0.0f, {1, 2, 3}, {0, 0, 0}, 60.0f}};
...
{
    std::vector<TestSequencer::CameraKeyframe> kfs = {{0.0f, {0, 0, 0}, {0, 0, 0}, 60.0f},
...
{
    std::vector<TestSequencer::CameraKeyframe> kfs = {{1.0f, {5, 0, 0}, {0, 0, 0}, 60.0f},
...
{
    std::vector<TestSequencer::SubtitleCue> subs = {{1.0f, 3.0f, "Hello"}};
...
{
    std::vector<TestSequencer::EventCue> cues = {{1.0f, "explosion"}, {2.0f, "door_open"}, {5.0f, "music_start"}};
...
{
    std::vector<TestSequencer::EventCue> cues = {{5.0f, "late_event"}};
...
{
    std::vector<TestSequencer::EventCue> cues = {{2.0f, "exact_event"}};
