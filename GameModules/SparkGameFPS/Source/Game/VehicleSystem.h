 ...
 */
     ...
     */
        void SetDestructionCallback(std::function<void(Vehicle*)> callback) { m_destructionCallback = callback; }
 ...
 */
     ...
     */
        Vehicle* SpawnVehicle(VehicleType type, const XMFLOAT3& position, ID3D11Device* device,
