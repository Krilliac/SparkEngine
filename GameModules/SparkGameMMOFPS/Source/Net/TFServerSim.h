...
namespace Terrafront
{
    ...
    class TFServerSim final : public Spark::Net::IAreaSimulation
    {
      ...
      private:
        ...
        void SendMoveStates();
        void SendToPlayer(PlayerId player, uint16_t msgId, const void* payload, size_t size, bool reliable);
        ...
        // W7 ui-map-keys: alive-pawn map redeploy — validated by TFRedeployRules::
        ...
        std::unordered_map<PlayerId, double> m_redeployNextAt; // W7 ui-map-keys: redeploy interval
