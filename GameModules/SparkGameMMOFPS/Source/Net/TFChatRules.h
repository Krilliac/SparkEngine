...
{
    return channel <= static_cast<uint8_t>(ChatChannel::Yell);
}
...
inline bool NormalizeChatText(const char* input, size_t inputSize,
...
inline bool ShouldReceiveChat(ChatChannel channel, const TFChatRouteView& view)
{
    ...
    switch (channel)
    {
        case ChatChannel::Region:  return view.sameRegion;
        case ChatChannel::Faction: return view.sameFaction;
        case ChatChannel::Squad:   return view.sameSquad;
        case ChatChannel::Yell:
            return view.bothHavePawns &&
...
inline const char* ChatChannelName(ChatChannel channel)
{
    switch (channel)
    {
        case ChatChannel::Region:  return "REGION";
        case ChatChannel::Faction: return "FACTION";
        case ChatChannel::Squad:   return "SQUAD";
