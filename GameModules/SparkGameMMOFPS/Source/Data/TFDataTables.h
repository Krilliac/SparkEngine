...
namespace Terrafront
{
    ...
    struct ContinentDef
    {
        std::string key; ///< stable continents.json identity; persistence namespace
        std::string name;
        float sizeM = 4096;
        std::string scene;
    ...
    struct SkyboxDef
    {
        ...
        std::string faceTex[6] = {
            "Textures/MMOFPS/sky/space_px.png", "Textures/MMOFPS/sky/space_nx.png", "Textures/MMOFPS/sky/space_py.png",
            "Textures/MMOFPS/sky/space_ny.png", "Textures/MMOFPS/sky/space_pz.png", "Textures/MMOFPS/sky/space_nz.png",
        };
