 ...
 *        rebroadcast and the client mirror. The billboarded diamond world
 *        markers live in TFPingSystemFx.cpp.
 *
...
#include "Graphics/Mesh.h" // complete type for the m_quad unique_ptr teardown
