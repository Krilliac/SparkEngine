...
- [Memory Management Patterns](Memory-Management-Patterns) — Ownership rules, allocators, debugging tools
- [Memory Integrity](Memory-Integrity) — Anti-tamper system, branch guards
- [Error Handling Patterns](Error-Handling-Patterns) — SPARK_VALIDATE, SPARK_CHECK patterns
- [Threading Model](Threading-Model) — Thread safety rules and mutex conventions
- [Testing](Testing) — CI sanitizer configuration and test infrastructure
