...
**Related pages:** [Asset Pipeline](Asset-Pipeline), [Asset Format Specifications](Asset-Format-Specifications), [SparkEditor](SparkEditor), [Terrain and Procedural Generation](Terrain-and-Procedural-Generation), [Collaborative Editing](Collaborative-Editing)
...
| **Scripts** | `.as` | AngelScript — see [Scripting with AngelScript](Scripting-with-AngelScript) |
...
- **Time-of-day:** The [Day/Night Cycle](Day-Night-Cycle-and-Weather) system drives the directional light color, intensity, and angle automatically. Artists configure the sky gradient and light curve in the editor.

---

## Terrain Workflow

See also: [Terrain and Procedural Generation](Terrain-and-Procedural-Generation)
...
See [Collaborative Editing](Collaborative-Editing) for setup and networking details.
...
- [Asset Pipeline](Asset-Pipeline) — how assets are loaded, cached, and streamed
- [Asset Format Specifications](Asset-Format-Specifications) — internal data formats
- [Scripting with AngelScript](Scripting-with-AngelScript) — gameplay scripting without C++
- [Visual Scripting](Visual-Scripting) — node-based logic for non-programmers
- [Rendering and Graphics](Rendering-and-Graphics) — graphics pipeline details
- [Day Night Cycle and Weather](Day-Night-Cycle-and-Weather) — time-of-day and weather systems
- [Shader Pipeline](Shader-Pipeline) — custom shader authoring
