...
- [Inventory System](Gameplay-Systems) -- Manages player items that loot populates and crafting consumes
- [DataTable System](DataTable-System) -- Loot tables and recipes can be loaded from CSV/JSON data tables
- [Quest System](Gameplay-Systems) -- Quests can reward loot table rolls or unlock recipes
