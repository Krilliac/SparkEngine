...
The mobile platform complements the desktop [Input System](../subsystems/Input-System.md). A typical setup routes touch events through the mobile platform while keyboard/mouse events go through the standard input system:
...
Quality settings from the mobile platform should be applied to the [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) system at initialization and whenever the preset changes:
...
Use safe area insets from the mobile platform to ensure [UI elements](../subsystems/UI-System.md) are not obscured by hardware features:
...
- [Input System](../subsystems/Input-System.md) — Keyboard/mouse input on desktop
- [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) — Quality settings and render scale
- [UI System](../subsystems/UI-System.md) — Touch-friendly UI layout
- [Build System and CMake Modules](../advanced/Build-System-and-CMake-Modules.md) — Mobile build configuration
