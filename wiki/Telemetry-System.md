...
- [Asset-Validation](Asset-Validation.md) -- Record validation metrics as telemetry events
- [Accessibility](Accessibility.md) -- Track accessibility feature usage
- [Platform-Input](Platform-Input.md) -- Record input analytics
- [Game-Packaging](Game-Packaging.md) -- Record packaging metrics
