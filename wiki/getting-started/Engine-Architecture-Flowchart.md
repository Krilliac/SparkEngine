...
_Generated from 719 headers, 595 source files, 79 ECS components, 11 ECS systems, 65 editor panels, 6 RHI backends._
<!-- /AUTO:flowchart_stats -->
...
```
 ...
 │ - Windowed or      │  │ - 65 editor panels │  │ - Command input │
...
The editor is a standalone executable that embeds the engine and adds a Dear ImGui-based interface with 65 specialized panels.
...
- `SparkEditor/Source/Panels/` — All 65 panel implementations
