...
- [Architecture Overview](../getting-started/Architecture-Overview.md) -- engine subsystem layout
- [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) -- D3D11 rendering pipeline and GPU resources
- [SparkConsole](../gameplay-tools/SparkConsole.md) -- in-game console for running debug commands
- [SparkEditor](../gameplay-tools/SparkEditor.md) -- ImGui editor with profiler integration
- [Testing](Testing.md) -- unit test framework and CTest integration
