...
| **Total C++ (excl. ThirdParty)** | **~779033** |
...
Graphics contains 121162 lines, or 37% of `SparkEngine/Source`. This is a source-inventory measurement, not runtime coverage or support evidence.
