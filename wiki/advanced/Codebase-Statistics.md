...
| **Total C++ (excl. ThirdParty)** | **~798721** |
...
Graphics contains 123375 lines, or 37% of `SparkEngine/Source`. This is a source-inventory measurement, not runtime coverage or support evidence.
