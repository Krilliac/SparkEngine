...
See [Profiler and Debugging](Profiler-and-Debugging.md) for runtime memory profiling tools.

See [Memory Safety](Memory-Safety.md) for type-safe utilities (NonNull, SafeCast, Contracts) and compiler hardening.
