...
- [Tween System](Tween-System.md) -- value interpolation over time (complementary to timers)
- [Coroutine Scheduler](Coroutine-System.md) -- async frame-based scheduling
- [ECS Systems](ECS-and-Components.md) -- gameplay systems can use TimerManager for periodic logic
- [Event System](Event-System.md) -- timers can fire events instead of direct callbacks
