...
SparkEngine includes dynamic time-of-day and weather systems that affect lighting, [rendering](../subsystems/Rendering-and-Graphics.md), and [gameplay](Gameplay-Systems.md). Both systems output parameters that feed into the lighting pipeline, post-processing, particle system, and audio engine, enabling rich atmospheric environments.
...
| Wet surfaces               | [Physics](../subsystems/Physics.md) friction coefficients reduced     |
...
- [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) — Volumetric lighting and fog
- [Event System](../subsystems/Event-System.md) — Weather and time-of-day events
- [Physics](../subsystems/Physics.md) — Weather effects on physics
- [Audio](../subsystems/Audio.md) — Weather-driven audio (thunder, rain, wind)
- [Gameplay Systems](Gameplay-Systems.md) — Weather impact on gameplay mechanics
- [Terrain and Procedural Generation](Terrain-and-Procedural-Generation.md) — Terrain interaction with weather
- [Entity-Component-System](../subsystems/Entity-Component-System.md) — ECS integration for weather-aware entities
