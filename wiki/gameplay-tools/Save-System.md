...
SparkEngine provides an [Entity Component System](../subsystems/Entity-Component-System.md)-aware save/load system with JSON serialization, miniz compression, multiple save slots, quicksave/quickload, rotating autosaves, and a per-component serializer registry.
...
- [Entity Component System](../subsystems/Entity-Component-System.md) -- Components that are serialized
- [Scene Management](../subsystems/Scene-Management.md) -- Scene state persistence
- [Scripting with AngelScript](../subsystems/Scripting-with-AngelScript.md) -- Script-driven save/load triggers
- [Event System](../subsystems/Event-System.md) -- Save/load event callbacks
- [Networking](../subsystems/Networking.md) -- Multiplayer state persistence
- [Gameplay Systems](Gameplay-Systems.md) -- Checkpoint and save triggers
