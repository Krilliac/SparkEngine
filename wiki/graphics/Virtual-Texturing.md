...
- **Asset Pipeline**: Source textures are pre-tiled during asset import. See [Asset Pipeline](../gameplay-tools/Asset-Pipeline.md)
...
- **Terrain**: Large terrain textures are ideal candidates for virtual texturing. See [Terrain and Procedural Generation](../gameplay-tools/Terrain-and-Procedural-Generation.md)
...
- [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) — Texture streaming and material system
- [Asset Pipeline](../gameplay-tools/Asset-Pipeline.md) — Asset import and texture processing
- [Terrain and Procedural Generation](../gameplay-tools/Terrain-and-Procedural-Generation.md) — Terrain texture streaming
