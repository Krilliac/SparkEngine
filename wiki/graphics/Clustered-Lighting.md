...
- **Volumetric Fog**: The fog scattering pass can reuse the clustered light list. See [Volumetric Fog](Volumetric-Fog.md)
...
- [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) — Overall lighting pipeline
- [Volumetric Fog](Volumetric-Fog.md) — Light scattering uses the same light data
- [Global Illumination](Global-Illumination.md) — Indirect lighting complements direct clustered lighting
- [GPU-Driven Rendering](GPU-Driven-Rendering.md) — GPU culling for geometry (parallel concept)
