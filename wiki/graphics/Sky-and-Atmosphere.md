...
The sky system integrates with the [Day/Night Cycle and Weather](../gameplay-tools/Day-Night-Cycle-and-Weather.md) systems:
...
The constant buffer (`m_gpuConstantBuffer`) is created through the [RHI](RHI-Abstraction-Layer.md) abstraction, making the system backend-agnostic.
