...
- **Physics**: Use `GetWaterHeight()` for buoyancy forces in [Physics](../subsystems/Physics.md) simulations
- **Audio**: Trigger splash sounds when objects enter water. See [Audio](../subsystems/Audio.md)
- **Particle System**: Spawn spray particles at wave crests
- **Sky Atmosphere**: Water color is affected by sky reflection. See [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md)

---

## See Also

- [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) — Overall rendering pipeline
- [Physics](../subsystems/Physics.md) — Buoyancy and fluid interaction
- [Terrain and Procedural Generation](../gameplay-tools/Terrain-and-Procedural-Generation.md) — Shoreline and riverbed terrain
- [Day Night Cycle and Weather](../gameplay-tools/Day-Night-Cycle-and-Weather.md) — Weather affects wave intensity
