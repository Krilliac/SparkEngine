...
- **MeshClusterSystem**: Provides meshlet-level data for GPU-driven rendering. See [GPU-Driven Rendering](GPU-Driven-Rendering.md)
- **D3D12 Backend**: Mesh shaders require D3D12 SM6.5 support. See [D3D12 Backend](D3D12-Backend.md)
- **Asset Pipeline**: Meshlet conversion can be done at asset import time. See [Asset Pipeline](../gameplay-tools/Asset-Pipeline.md)
- **LOD System**: Meshlet groups integrate with the existing mesh LOD system. See [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md)

---

## See Also

- [GPU-Driven Rendering](GPU-Driven-Rendering.md) — Compute-based culling for traditional geometry
- [D3D12 Backend](D3D12-Backend.md) — D3D12 feature tiers and mesh shader capability
- [Rendering and Graphics](../subsystems/Rendering-and-Graphics.md) — Overall rendering architecture
- [RHI Abstraction Layer](RHI-Abstraction-Layer.md) — Cross-backend abstraction
