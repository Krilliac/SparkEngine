...
These limitations are documented in the [Codebase Health](../advanced/Codebase-Health.md) wiki page under architectural considerations.
...
- [Architecture Overview](../getting-started/Architecture-Overview.md) -- Engine architecture, subsystem layout, and key patterns
- [Entity Component System](Entity-Component-System.md) -- ECS architecture, components, systems, and the `ParallelSystemExecutor`
- [AI and Navigation](AI-and-Navigation.md) -- Behavior trees, NavMesh, and parallel perception
- [Testing](../advanced/Testing.md) -- Unit tests and CTest integration
- [Profiler and Debugging](../advanced/Profiler-and-Debugging.md) -- Profiler, debug overlays, and performance measurement
