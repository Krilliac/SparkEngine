...
Use `AIComponent` on entities (see [Entity Component System](Entity-Component-System.md)):
...
- [Entity Component System](Entity-Component-System.md) -- AIComponent
- [Gameplay Systems](../gameplay-tools/Gameplay-Systems.md) -- NPC and combat systems
- [Animation](Animation.md) -- NPC animation state machines
- [Physics](Physics.md) -- Steering and collision avoidance
- [Event System](Event-System.md) -- AI-related event publishing
- [Terrain and Procedural Generation](../gameplay-tools/Terrain-and-Procedural-Generation.md) -- NavMesh generation on terrain
- [Scripting with AngelScript](Scripting-with-AngelScript.md) -- Scripting AI behaviors
