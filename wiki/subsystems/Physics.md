...
3. Writes updated transforms back to the [ECS](Entity-Component-System.md) `TransformComponent`
...
- [Entity Component System](Entity-Component-System.md) -- RigidBody and Collider components
- [Rendering and Graphics](Rendering-and-Graphics.md) -- Debug draw overlay
- [Gameplay Systems](../gameplay-tools/Gameplay-Systems.md) -- Player controller, weapons, and vehicles
- [Terrain and Procedural Generation](../gameplay-tools/Terrain-and-Procedural-Generation.md) -- Heightfield collision shapes
- [Animation](Animation.md) -- Physics-driven animation and ragdolls
- [Day Night Cycle and Weather](../gameplay-tools/Day-Night-Cycle-and-Weather.md) -- Environmental physics interactions
