...
When using the [Area Server Architecture](Area-Server-Architecture), each AreaServer has its own coordinate space. The WorldServer mediates coordinate translation during entity migration:
