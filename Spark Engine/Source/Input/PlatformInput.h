...
enum class KeyCode : uint16_t {
    ...
    MouseButton4, MouseButton5,                ///< Extra mouse buttons (side buttons)
...
enum class GamepadBtn : uint8_t {
    ...
    LeftBumper, RightBumper,                  ///< Shoulder bumpers
    Back, Start, Guide,                       ///< Menu buttons
    LeftStick, RightStick,                    ///< Thumbstick clicks
    DPadUp, DPadDown, DPadLeft, DPadRight,   ///< D-pad directional buttons
    Count                                     ///< Sentinel for array sizing
};
...
struct InputEvent {
    ...
    enum class Type {
        ...
        MouseMove, MouseScroll,            ///< Mouse movement or scroll wheel
        GamepadButton, GamepadAxis,        ///< Gamepad button or axis change
