...
{
    if (!isReady || isActive || currentEnergy < energyCost) return false;
...
{
    if (cooldownMax <= 0.0f) return 1.0f;
...
void ClassSystem::Update(float dt)
{
    ...
    m_deployables.erase(
        std::remove_if(m_deployables.begin(), m_deployables.end(),
            [](const Deployable& d) { return !d.isActive; }),
        m_deployables.end()
    );
}
...
void ClassSystem::InitLightAssault()
{
    ...
    // Allowed weapons
    def.allowedWeapons = {
        WeaponType::ASSAULT_RIFLE, WeaponType::SUBMACHINE_GUN,
...
void ClassSystem::InitCombatMedic()
{
    ...
    // Allowed weapons
    def.allowedWeapons = {
        WeaponType::ASSAULT_RIFLE, WeaponType::RIFLE,
        WeaponType::PISTOL, WeaponType::SUBMACHINE_GUN,
        WeaponType::MEDICAL_TOOL, WeaponType::MELEE_WEAPON
    };
...
void ClassSystem::InitEngineer()
{
    ...
    // Allowed weapons
    def.allowedWeapons = {
        WeaponType::SUBMACHINE_GUN, WeaponType::SHOTGUN,
        WeaponType::PISTOL, WeaponType::ASSAULT_RIFLE,
        WeaponType::REPAIR_TOOL, WeaponType::MELEE_WEAPON
    };
...
void ClassSystem::InitInfiltrator()
{
    ...
    // Allowed weapons
    def.allowedWeapons = {
        WeaponType::SNIPER_RIFLE, WeaponType::SUBMACHINE_GUN,
        WeaponType::PISTOL, WeaponType::CROSSBOW,
        WeaponType::THROWING_KNIFE, WeaponType::SCANNER,
...
void ClassSystem::InitHeavyAssault()
{
    ...
    // Allowed weapons
    def.allowedWeapons = {
        WeaponType::MACHINE_GUN, WeaponType::ROCKET_LAUNCHER,
        WeaponType::PISTOL, WeaponType::ASSAULT_RIFLE,
        WeaponType::MINIGUN, WeaponType::SHOTGUN,
        WeaponType::MELEE_WEAPON
    };
...
void ClassSystem::InitMAXSuit()
{
    ...
    def.allowedWeapons = {
        WeaponType::MINIGUN, WeaponType::MACHINE_GUN,
        WeaponType::GRENADE_LAUNCHER, WeaponType::ROCKET_LAUNCHER,
        WeaponType::FLAMETHROWER, WeaponType::PLASMA_RIFLE,
        WeaponType::MELEE_WEAPON
    };
...
{
    auto it = m_classes.find(static_cast<int>(classType));
    if (it != m_classes.end()) return it->second.primaryAbility;
...
{
    auto it = m_classes.find(static_cast<int>(classType));
    if (it != m_classes.end()) return it->second.secondaryAbility;
    return m_defaultAbility;
}
...
{
    if (static_cast<int>(m_deployables.size()) >= MAX_DEPLOYABLES) return -1;
...
{
    switch (classType) {
    case PlayerClass::LIGHT_ASSAULT: return "Light Assault";
    case PlayerClass::COMBAT_MEDIC:  return "Combat Medic";
    case PlayerClass::ENGINEER:      return "Engineer";
    case PlayerClass::INFILTRATOR:   return "Infiltrator";
    case PlayerClass::HEAVY_ASSAULT: return "Heavy Assault";
    case PlayerClass::MAX_SUIT:      return "MAX Suit";
...
{
    switch (ability) {
    case ClassAbility::JETPACK:         return "Jetpack";
    case ClassAbility::SPRINT_BOOST:    return "Sprint Boost";
    case ClassAbility::HEAL_AURA:       return "Healing Aura";
    case ClassAbility::REVIVE:          return "Revive";
    case ClassAbility::DEPLOY_TURRET:   return "Deploy Turret";
    case ClassAbility::DEPLOY_BARRIER:  return "Deploy Barrier";
    case ClassAbility::CLOAK:           return "Cloak";
    case ClassAbility::RECON_DART:      return "Recon Dart";
    case ClassAbility::OVERSHIELD:      return "Overshield";
    case ClassAbility::ROCKET_BARRAGE:  return "Rocket Barrage";
    case ClassAbility::LOCKDOWN:        return "Lockdown";
    case ClassAbility::EMERGENCY_REPAIR:return "Emergency Repair";
    default: return "None";
    }
}
