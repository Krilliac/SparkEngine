 ...
 */
     ...
     */
        ...
        void Log(LogLevel level, const std::string& category, const std::string& message, const std::string& file = "",
        ...
        bool ExportLogs(const std::string& filename, std::function<bool(const LogEntry&)> filter = nullptr) const;
...
#define SE_LOG_TRACE(category, message)                                                                                \
    SparkEditor::EditorLogger::GetInstance().Log(SparkEditor::LogLevel::TRACE, category, message, __FILE__, __LINE__,  \
                                                 __FUNCTION__)

#define SE_LOG_DEBUG(category, message)                                                                                \
    SparkEditor::EditorLogger::GetInstance().Log(SparkEditor::LogLevel::DEBUG, category, message, __FILE__, __LINE__,  \
                                                 __FUNCTION__)

#define SE_LOG_INFO(category, message)                                                                                 \
    SparkEditor::EditorLogger::GetInstance().Log(SparkEditor::LogLevel::INFO, category, message, __FILE__, __LINE__,   \
                                                 __FUNCTION__)

#define SE_LOG_WARNING(category, message)                                                                              \
    SparkEditor::EditorLogger::GetInstance().Log(SparkEditor::LogLevel::WARNING, category, message, __FILE__,          \
                                                 __LINE__, __FUNCTION__)

#define SE_LOG_ERROR(category, message)                                                                                \
    SparkEditor::EditorLogger::GetInstance().Log(SparkEditor::LogLevel::ERROR_, category, message, __FILE__, __LINE__, \
                                                 __FUNCTION__)

#define SE_LOG_CRITICAL(category, message)                                                                             \
    SparkEditor::EditorLogger::GetInstance().Log(SparkEditor::LogLevel::CRITICAL, category, message, __FILE__,         \
                                                 __LINE__, __FUNCTION__)
