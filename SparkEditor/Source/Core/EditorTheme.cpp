...
bool EditorTheme::ApplyTheme(const std::string& themeName) {
    ...
    if (it == s_registeredThemes.end()) {
        ...
        if (it == s_registeredThemes.end()) return false;
    }
...
std::vector<std::string> EditorTheme::GetAvailableThemes() {
    if (s_registeredThemes.empty()) InitializeDefaultThemes();
...
EditorThemeData EditorTheme::CreateVSProTheme() {
    ...
    t.graph1 = t.accent; t.graph2 = t.accentSecondary;
    t.graph3 = t.textSuccess; t.graph4 = t.textError; t.graph5 = ThemeColor::FromRGB(140, 70, 210);
...
EditorThemeData EditorTheme::CreateJetBrainsTheme() {
    ...
    t.graph1 = t.accent; t.graph2 = t.textWarning;
    t.graph3 = t.textSuccess; t.graph4 = t.textError; t.graph5 = ThemeColor::FromRGB(140, 70, 210);
...
EditorThemeData EditorTheme::CreateProfessionalLightTheme() {
    ...
    t.graph1 = t.accent; t.graph2 = t.textWarning;
    t.graph3 = t.textSuccess; t.graph4 = t.textError; t.graph5 = ThemeColor::FromRGB(120, 60, 190);
...
EditorThemeData EditorTheme::CreateHighContrastTheme() {
    ...
    t.graph1 = t.accent; t.graph2 = t.textWarning;
    t.graph3 = t.textSuccess; t.graph4 = t.textError; t.graph5 = ThemeColor::FromRGB(200, 100, 255);
