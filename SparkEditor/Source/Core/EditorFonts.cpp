...
namespace SparkEditor
{
    ...
    void EditorFonts::LoadFonts(float baseFontSize)
    {
        ...
        s_defaultFont =
            io.Fonts->AddFontFromFileTTF((fontDir + "Roboto-Regular.ttf").c_str(), baseFontSize, &defaultConfig);
        ...
        s_largeFont =
            io.Fonts->AddFontFromFileTTF((fontDir + "Roboto-Bold.ttf").c_str(), baseFontSize + 5.0f, &largeConfig);
