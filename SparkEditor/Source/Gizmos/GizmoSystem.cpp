...
void GizmoSystem::ApplyRotation(GizmoAxis /*axis*/, float /*angleDelta*/,
                                std::vector<Transform*>& /*transforms*/) {
}

void GizmoSystem::ApplyScale(const XMFLOAT3& /*scale*/, GizmoAxis /*axis*/,
                             std::vector<Transform*>& /*transforms*/) {
}
...
XMFLOAT4 GizmoSystem::GetAxisColor(GizmoAxis /*axis*/, bool /*isHighlighted*/,
