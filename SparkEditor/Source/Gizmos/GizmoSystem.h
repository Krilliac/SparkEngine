 ...
 */
     ...
     */
        static Ray ScreenToWorldRay(float screenX, float screenY, const XMMATRIX& viewMatrix,
 ...
 */
     ...
     * @param viewport Viewport dimensions
     */
        void Render(const std::vector<Transform*>& selectedObjects, const XMMATRIX& viewMatrix,
                    const XMMATRIX& projMatrix, const XMFLOAT4& viewport);
     ...
     */
        bool HandleMouseInput(float mouseX, float mouseY, bool isMouseDown, const XMMATRIX& viewMatrix,
                              const XMMATRIX& projMatrix, const XMFLOAT4& viewport,
     ...
     * @param projMatrix Projection matrix
     */
        void RenderTranslationGizmo(const Transform& transform, const XMMATRIX& viewMatrix, const XMMATRIX& projMatrix);
     ...
     * @param projMatrix Projection matrix
     */
        void RenderRotationGizmo(const Transform& transform, const XMMATRIX& viewMatrix, const XMMATRIX& projMatrix);
     ...
     * @param projMatrix Projection matrix
     */
        void RenderScaleGizmo(const Transform& transform, const XMMATRIX& viewMatrix, const XMMATRIX& projMatrix);
