...
namespace SparkEditor
{
    ...
    void TerrainEditor::GenerateNoiseHeightmap(int /*octaves*/, float /*frequency*/, float /*amplitude*/,
    ...
    void TerrainEditor::ApplyErosion(int /*iterations*/, float /*strength*/, float /*evaporationRate*/,
    ...
    void TerrainEditor::PaintTextureWeight(int /*centerX*/, int /*centerY*/, float /*radius*/, int /*layerIndex*/,
                                           float /*strength*/)
    {
    }
