...
class PolicyFixture:
    ...
    def fuzz_cmake(self) -> pathlib.Path:
        return self.root / "FuzzerTests" / "CMakeLists.txt"

    @property
    def harness(self) -> pathlib.Path:
        return self.root / "FuzzerTests" / "ExampleFuzz.cpp"
    ...
    def make_fuzzed(self) -> None:
        fuzz_dir = self.root / "FuzzerTests"
        ...
        seeds = self.root / "FuzzerTests" / "corpora" / "example"
        ...
        parser.pop("blocker")
        parser["target"] = {
            "harness": "FuzzerTests/ExampleFuzz.cpp",
            "cmake_file": "FuzzerTests/CMakeLists.txt",
        ...
        self.corpus["corpora"] = [
            {
                ...
                "corpus_dir": "FuzzerTests/corpora/example",
                "last_verified": TODAY.isoformat(),
                "content_digest": corpus_digest(self.root, "FuzzerTests/corpora/example"),
                "budget": {
                    "max_input_bytes": 128,
...
class TestCorpusBinding(FixtureTestCase):
    ...
    def test_c_abi_harness_can_bind_through_a_production_adapter(self) -> None:
        self.fixture.make_fuzzed()
        adapter_header = self.root / "FuzzerTests" / "ProductionAdapter.h"
        ...
        adapter = self.root / "FuzzerTests" / "ProductionAdapter.cpp"
        adapter.write_text(
        ...
        self.fixture.inventory["parsers"][0]["target"]["binding_source"] = "FuzzerTests/ProductionAdapter.cpp"
    ...
    def test_literal_blob_comment_is_rejected(self) -> None:
        ...
        self.fixture.rewrite_cmake(
            "# FuzzExampleParser FuzzExampleParserSmoke FuzzerTests/ExampleFuzz.cpp "
    ...
    def test_target_must_compile_the_declared_harness(self) -> None:
        self.fixture.make_fuzzed()
        (self.root / "FuzzerTests" / "Other.cpp").write_text("int other;\n", encoding="utf-8")
    ...
    def test_relative_harness_path_must_resolve_from_the_listfile(self) -> None:
        self.fixture.make_fuzzed()
        # The repo-relative spelling would resolve to FuzzerTests/FuzzerTests/...
        self.fixture.rewrite_cmake(FUZZ_CMAKE.replace("ExampleFuzz.cpp ", "FuzzerTests/ExampleFuzz.cpp ", 1))
        with self.assertPolicyError("does not compile the declared harness"):
            self.fixture.load_corpora()
    ...
    def test_unreviewed_input_path_is_rejected(self) -> None:
        self.fixture.make_fuzzed()
        (self.root / "FuzzerTests" / "corpora" / "other").mkdir()
        self.fixture.rewrite_cmake(
            FUZZ_CMAKE.replace(
                "${CMAKE_SOURCE_DIR}/FuzzerTests/corpora/example",
                "${CMAKE_SOURCE_DIR}/FuzzerTests/corpora/example ${CMAKE_SOURCE_DIR}/FuzzerTests/corpora/other",
            )
        )
    ...
    def test_cmake_file_must_be_a_cmake_listfile(self) -> None:
        self.fixture.make_fuzzed()
        self.fixture.inventory["parsers"][0]["target"]["cmake_file"] = "FuzzerTests/ExampleFuzz.cpp"
        self.fixture.write_inventory()
    ...
    def test_changed_seed_invalidates_the_verification_date(self) -> None:
        self.fixture.make_fuzzed()
        (self.root / "FuzzerTests" / "corpora" / "example" / "nested.json").write_bytes(b'{"a":9}')
    ...
    def test_empty_seed_is_fatal(self) -> None:
        self.fixture.make_fuzzed()
        (self.root / "FuzzerTests" / "corpora" / "example" / "empty-object.json").write_bytes(b"")
    ...
    def test_hardlinked_seed_is_fatal(self) -> None:
        self.fixture.make_fuzzed()
        seed = self.root / "FuzzerTests" / "corpora" / "example" / "empty-object.json"
        try:
    ...
    def test_corpus_outside_the_reviewed_root_is_fatal(self) -> None:
        ...
        self.fixture.write_corpus()
        with self.assertPolicyError("must live under FuzzerTests/corpora"):
            self.fixture.load_corpora()
...
class TestWorkflowBinding(unittest.TestCase):
    ...
    def test_run_commands_preserve_execution_order(self) -> None:
        ...
        build = "cmake --build build/fuzz-policy --target SparkFuzzJsonUtils SparkFuzzCrashManifest SparkFuzzNeuralWeights SparkFuzzTextureStex SparkFuzzSceneManifest"
...
class TestCiBindingMutations(unittest.TestCase):
    ...
    def test_inventory_fuzz_target_missing_from_build_command_is_rejected(self) -> None:
        self.fixture.patch(
            ".github/workflows/build.yml",
            "      run: cmake --build build/fuzz-policy --target SparkFuzzJsonUtils SparkFuzzCrashManifest SparkFuzzNeuralWeights SparkFuzzTextureStex SparkFuzzSceneManifest",
    ...
    def test_inventory_fuzz_build_after_ctest_is_rejected(self) -> None:
        ...
        text = path.read_text(encoding="utf-8")
        build = "      run: cmake --build build/fuzz-policy --target SparkFuzzJsonUtils SparkFuzzCrashManifest SparkFuzzNeuralWeights SparkFuzzTextureStex SparkFuzzSceneManifest"
...
class TestRepositoryIntegration(unittest.TestCase):
    ...
    def test_json_utils_has_a_production_fuzz_binding(self) -> None:
        ...
        self.assertEqual(parser.target["harness"], "FuzzerTests/FuzzJsonUtils.cpp")
        self.assertEqual(parser.target["cmake_file"], "FuzzerTests/CMakeLists.txt")
        ...
        self.assertEqual(parser.target["binding_source"], "FuzzerTests/FuzzJsonUtilsProduction.cpp")
        ...
        self.assertEqual(corpus.corpus_dir, "FuzzerTests/corpora/json-utils")
    ...
    def test_neural_weights_has_a_production_fuzz_binding(self) -> None:
        ...
        self.assertIsNotNone(parser.target)
        assert parser.target is not None
        self.assertEqual(parser.target["harness"], "FuzzerTests/FuzzNeuralWeights.cpp")
        ...
        self.assertEqual(corpus.corpus_dir, "FuzzerTests/corpora/neural-weights-nnw")
        self.assertEqual(corpus.budget.max_input_bytes, 4096)
        self.assertEqual(corpus.budget.max_parse_time_ms, 1000)
        self.assertEqual(corpus.budget.max_memory_mb, 256)
    ...
    def test_committed_paths_use_canonical_case(self) -> None:
        ...
        miscased = [path for path in policy_paths if not path.startswith(("tools/fuzz-policy/", "FuzzerTests/policy/"))]
    ...
    def test_suite_discovers_a_meaningful_number_of_tests(self) -> None:
        ...
        discovered = loader.discover(str(REPO_ROOT / "FuzzerTests" / "policy"), pattern="test_*.py")
