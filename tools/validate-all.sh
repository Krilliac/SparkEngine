...
case "${1:-check}" in
    ...
    help|--help|-h)
        ...
        echo "  tools/check-test-registration.sh Test source registration"
        ...
        echo "  tools/check-supply-chain.sh            Supply-chain policy enforcement"
        echo "  tools/check-fuzz-policy.sh       SEC-120 parser inventory and fuzz policy"
...
run_check "Test Source Registration"     "check-test-registration.sh"
...
run_check "ThirdParty Manifest Sync"    "check-thirdparty-manifest-sync.sh"
    run_check "Supply-Chain Policy"         "check-supply-chain.sh"
    run_check "SEC-120 Fuzz Policy"          "check-fuzz-policy.sh"
