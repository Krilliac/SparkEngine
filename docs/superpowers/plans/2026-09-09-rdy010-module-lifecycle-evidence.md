...
~~~bash
python3 tools/module-evidence/validate_manifest.py --repo-root "$GITHUB_WORKSPACE" --lifecycle-evidence "$GITHUB_WORKSPACE/build/module-evidence/module-lifecycle.json" --expected-sha "$MODULE_EVIDENCE_SHA" --allow-declared-gaps tools/module-evidence/evidence-gaps.json
~~~
