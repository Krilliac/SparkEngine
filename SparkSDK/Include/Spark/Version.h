...
inline constexpr uint32_t GetEngineVersion() { return SPARK_ENGINE_VERSION_PACKED; }

/** @brief Get the SDK ABI version at runtime */
inline constexpr uint32_t GetSDKVersion() { return SPARK_SDK_VERSION; }
