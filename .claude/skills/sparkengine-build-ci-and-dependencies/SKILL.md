...
| `build-linux-msan` | Clang + MSan-instrumented libc++ 18.1.3 built in-job and cached, `continue-on-error` (advisory until a run classifies clean), builds only `SparkTests` |
