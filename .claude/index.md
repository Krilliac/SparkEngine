...
- **Tests**: 333 test files, 4290 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~510K lines of C++ across 1569 source files, 117 wiki pages
