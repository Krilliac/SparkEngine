...
- **Tests**: 359 test files, 4655 tests on SparkTests (Phases U+V+W add 44 new tests: 9 ShaderHotReload wire-up + 16 ShaderDiskCache wire-up + 19 ShaderCrossCompiler wire-up); all pass on native Linux; total 118932+ assertions. Theme 3A (shader hot-reload surface) **complete** — all three orphans activated.
