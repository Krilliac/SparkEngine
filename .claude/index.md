...
- **Tests**: 309 test files, 3797 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~493K lines of C++ across 1522 source files, 103 wiki pages
