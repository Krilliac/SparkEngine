...
- **Tests**: 298 test files, 3670 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~481K lines of C++ across 1482 source files, 103 wiki pages
