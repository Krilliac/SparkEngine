...
- **Tests**: 327 test files, 4154 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~506K lines of C++ across 1555 source files, 117 wiki pages
