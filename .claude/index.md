...
- **Tests**: 332 test files, 4261 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~508K lines of C++ across 1560 source files, 117 wiki pages
