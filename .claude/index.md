...
- **Tests**: 321 test files, 3920 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~502K lines of C++ across 1546 source files, 103 wiki pages
