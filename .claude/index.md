...
- **Tests**: 366 test files, 4729 tests on SparkTests on Linux (Phase U–BB add 142 cumulative new tests; ImGui-gated Phase AA tests inactive without libimgui). Theme 3A **complete**; Theme 3B **complete for compilable-on-Linux scope**; Theme 3C **2 of 4 outside-Panels/ orphans wired**; Theme 3D Phase BB landed two SparkEngine singleton orphans (ScriptHookManager + DynamicQualityScaler) into the engine lifecycle with 25 real-class tests.
