...
- **Tests**: 297 test files, 3662 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~479K lines of C++ across 1481 source files, 102 wiki pages
