...
- **Tests**: 303 test files, 3727 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~486K lines of C++ across 1501 source files, 103 wiki pages
