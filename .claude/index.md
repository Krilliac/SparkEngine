...
- **Tests**: 339 test files, 4373 tests (all pass on native Linux except 1 pre-existing MMO test)
...
- **Codebase**: ~512K lines of C++ across 1575 source files, 125 wiki pages
