...
- **Tests**: 358 test files, 4636 tests on SparkTests (Phases U+V add 25 new tests: 9 ShaderHotReload wire-up + 16 ShaderDiskCache wire-up); all pass on native Linux; total 118893+ assertions
