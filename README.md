...
**Tests:** 6,987 test definitions across 577 files covering core utilities, ECS, physics, AI, animation, networking, gameplay, graphics, editor, and 50+ other subsystems.
...
├── Tests/                 6,987 test definitions, 577 files
