...
**Tests:** 7,574 test definitions across 634 files covering core utilities, ECS, physics, AI, animation, networking, gameplay, graphics, editor, and 50+ other subsystems.
...
├── Tests/                 7,574 test definitions, 634 files
