...
**Tests:** 7,380 test definitions across 606 files covering core utilities, ECS, physics, AI, animation, networking, gameplay, graphics, editor, and 50+ other subsystems.
...
├── Tests/                 7,380 test definitions, 606 files
