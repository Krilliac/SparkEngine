 ...
 */
    struct DamageIndicator
    {
        ...
        DamageIndicator(float a, float i, float t) : angle(a), intensity(i), timeRemaining(t), maxTime(t) {}
    };
 ...
 */
    struct KillFeedEntry
    {
        ...
        KillFeedEntry(const std::string& killer, const std::string& victim, const std::string& weapon, bool headshot,
                      float duration = 5.0f)
            : killerName(killer), victimName(victim), weaponName(weapon), isHeadshot(headshot), timeRemaining(duration)
        {
        }
    };
 ...
 */
    struct HUDConfig
    {
        ...
        struct
        {
            int r = 76, g = 175, b = 80, a = 220;
        } healthColor;
        struct
        {
            int r = 45, g = 140, b = 240, a = 220;
        } armorColor;
        struct
        {
            int r = 0, g = 200, b = 255, a = 200;
        } shieldColor; ///< Shield bar color (cyan)
        struct
        {
        ...
        struct
        {
            int r = 229, g = 57, b = 53, a = 180;
        } damageColor;
        struct
        {
            int r = 255, g = 200, b = 50, a = 220;
        } energyColor; ///< Ability energy (gold)
        struct
        {
            int r = 200, g = 100, b = 255, a = 200;
        } abilityColor; ///< Ability cooldown (purple)
        struct
        {
        ...
        } jetpackColor; ///< Jetpack fuel (orange)
        struct
        {
            int r = 150, g = 150, b = 200, a = 150;
        } cloakColor; ///< Cloak indicator (faded blue)
    };
 ...
 */
     ...
     * @param intensity Damage normalized 0-1
     */
        void AddDamageFromWorldPos(const DirectX::XMFLOAT3& damageSource, const DirectX::XMFLOAT3& playerPos,
                                   const DirectX::XMFLOAT3& playerForward, float intensity);
     ...
     */
        void AddKillFeedEntry(const std::string& killer, const std::string& victim, const std::string& weapon,
                              bool headshot = false);
