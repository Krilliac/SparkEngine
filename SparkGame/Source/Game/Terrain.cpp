...
// Linux stubs for Terrain (D3D11-dependent)
HRESULT Terrain::Initialize(ID3D11Device*, ID3D11DeviceContext*, const wchar_t*, UINT, UINT, float) { return E_FAIL; }
void Terrain::Render(ID3D11DeviceContext*) {}
